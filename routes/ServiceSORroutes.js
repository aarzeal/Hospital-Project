...
router.post('/ServiceSor', validateJSONContentType,authenticate,Userverifiction,ensureSequelizeInstance,serviceSOR.createServiceSOR);
...
router.put('/ServiceSor/:serviceSOR_ID', authenticate,Userverifiction,ensureSequelizeInstance,serviceSOR.updateOrCreateServiceSOR);
