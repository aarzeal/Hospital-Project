...
router.post('/doctors', authenticate,validateJSONContentType,createDoctorValidationRules(),hospitalController.ensureSequelizeInstance, doctorController.createDoctor);
