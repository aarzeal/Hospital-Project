...
router.post('/skills', authenticate,validateJSONContentType,createStaffValidationRules(),  hospitalController.ensureSequelizeInstance,skillController.createSkill);

// PUT update an existing skill
router.put('/skills/:id',authenticate, validateJSONContentType,updateStaffValidationRules(), hospitalController.ensureSequelizeInstance,skillController.updateSkill);
