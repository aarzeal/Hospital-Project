...
router.post('/itemGroup', validateJSONContentType,validator.validateItemGroup,authenticate,userverifiction,ensureSequelizeInstance,itemGroupController.createItemGroup);
...
router.put('/itemGroup/:Item_Group_id',validateJSONContentType,validator.validateItemGroupUpdate,userverifiction, authenticate,ensureSequelizeInstance,itemGroupController.updateItemGroup);
