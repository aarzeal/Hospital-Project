...
router.post('/create-ItemCompany', validateJSONContentType,validator.validateItem,authenticate,Userverifiction,ensureSequelizeInstance,itemCompany.createInvProduct);
...
router.put('/update-ItemCompany/:id',validateJSONContentType,validator.validateItemupdate,authenticate, Userverifiction,ensureSequelizeInstance,itemCompany.updateInvProduct);
