...
// exports.submoduleFieldsBulkSchema = Joi.array().items(
//   Joi.object({
//     fieldName: Joi.string().max(200).required().messages({
//     "string.base": "Field Name must be a string",
//     "string.empty": "Field Name is required",
//     "string.max": "Field Name must not exceed 200 characters",
...
exports.submoduleFieldsBulkSchema = Joi.object({
...
exports.submoduleFieldsSchema = Joi.object({
  fieldName: Joi.string().max(200).required().messages({
    "string.base": "Field Name must be a string",
    "string.empty": "Field Name is required",
    "string.max": "Field Name must not exceed 200 characters",
  ...
  fieldType: Joi.string().max(50).required().messages({
    "string.base": "Field Type must be a string",
    "string.empty": "Field Type is required",
    "string.max": "Field Type must not exceed 50 characters",
    "any.required": "Field Type is required",
  }),
    submoduleId: Joi.number().required(),
  isActive: Joi.boolean().required().messages({
  ...
  exports.roleFieldPermission = Joi.object({
  ...
  permission: Joi.string().valid('create', 'read', 'update', 'delete', 'display', 'disable', 'no_access').required().messages({
    "string.base": "Permission must be a string",
    "string.empty": "Permission is required",
    "any.required": "Permission is required",
    "any.only": "Permission must be one of: create, read, update, delete, disable, display, no_access"
  }),
...
exports.roleFieldPermissionBulk = Joi.object({
  roleId: Joi.number().required().messages({
    "number.base": "Role ID must be a number",
    "any.required": "Role ID is required",
  }),
  ...
  "any.required": "Role Field Permission object is required",
});
